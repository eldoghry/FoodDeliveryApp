...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        const argsUserController_create: Record<string, TsoaRoute.ParameterSchema> = {
                createUserDto: {"in":"body","name":"createUserDto","required":true,"ref":"CreateUserBody"},
        };
        ...
        const argsUserController_getAll: Record<string, TsoaRoute.ParameterSchema> = {
                queries: {"in":"queries","name":"queries","required":true,"ref":"GetUsersQuery"},
        };
        app.get('/api/v1/user',
            ...(fetchMiddlewares<RequestHandler>(UserController)),
        ...
        app.get('/api/v1/user/test',
            ...
            async function UserController_test(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsUserController_test, request, response });
